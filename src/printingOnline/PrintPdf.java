...
public class PrintPdf {
    ...
    public PrintPdf(String path) throws IOException, PrinterException {
        FileInputStream fis = new FileInputStream(path);
        PrintPdf printPDFFile = new PrintPdf(fis, "PET SHEET OF");
        printPDFFile.print();
    }
    ...
    public static void main(String[] args) throws IOException, PrinterException {
        ...
        FileInputStream fis = new FileInputStream("petsheet_2013.pdf");
        PrintPdf printPDFFile = new PrintPdf(fis, "PET SHEET OF");
        printPDFFile.print();
    }

    public static void printpdf(String path, String rollnumber, String name) throws IOException, PrinterException {

        FileInputStream fis = new FileInputStream(path);
        PrintPdf printPDFFile = new PrintPdf(fis, "PET SHEET OF " + rollnumber + " : " + name);
        printPDFFile.print();
    }

    public static void printpdf(String path, String rollnumber) throws IOException, PrinterException {

        FileInputStream fis = new FileInputStream(path);
        PrintPdf printPDFFile = new PrintPdf(fis, "PET SHEET OF " + rollnumber);
        printPDFFile.print();
    }

    public static void printpdf(String path) throws IOException, PrinterException {
...
//	}
    ...
    private void initialize(byte[] pdfContent, String jobName) throws IOException, PrinterException {
        ...
        paper.setImageableArea(43, 43, 509, 756);//0, 0, paper.getWidth(), paper.getHeight());
        pf.setPaper(paper);
    }
